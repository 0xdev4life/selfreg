...
/* harmony import */ var _angular_material_menu__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! @angular/material/menu */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/menu.js");
...
/* harmony import */ var _components_account_application_application_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./components/account/application/application.component */ "./src/app/components/account/application/application.component.ts");
/* harmony import */ var _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./tools/custom.pipe */ "./src/app/tools/custom.pipe.ts");
/* harmony import */ var _components_account_search_search_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./components/account/search/search.component */ "./src/app/components/account/search/search.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        ...
        _components_account_application_application_component__WEBPACK_IMPORTED_MODULE_37__["ApplicationComponent"],
        _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["ApplicantPipe"],
        _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["TrademarkPipe"],
        _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["StatusPipe"],
        _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["ModePipe"],
        _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["OptionPipe"],
        _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["DocTypesPipe"],
        _components_account_search_search_component__WEBPACK_IMPORTED_MODULE_39__["SearchComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_19__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_19__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_20__["HttpClientModule"],
        _tools_app_routing_module__WEBPACK_IMPORTED_MODULE_15__["AppRoutingModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["OptionPipe"],
                    _tools_custom_pipe__WEBPACK_IMPORTED_MODULE_38__["DocTypesPipe"],
                    _components_account_search_search_component__WEBPACK_IMPORTED_MODULE_39__["SearchComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_forms__WEBPACK_IMPORTED_MODULE_19__["FormsModule"],
...
function SearchComponent_div_22_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchComponent_div_22_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r201); const cl_r199 = ctx.$implicit; const ctx_r200 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r200.selectClass(cl_r199); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const cl_r199 = ctx.$implicit;
...
function SearchComponent_div_31_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 24);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchComponent_div_31_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r204); const cl_r202 = ctx.$implicit; const ctx_r203 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r203.selectClass(cl_r202); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const cl_r202 = ctx.$implicit;
...
function SearchComponent_mat_expansion_panel_35_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = function () { return { goback: true }; };
const _c1 = function () { return { gobackmobile: true }; };
...
class SearchComponent {
    ...
    selectClass(cl) {
        const idx = this.classes.indexOf(cl);
        if (idx >= 0) {
            if (this.classes[idx].selected === 'none') {
                ...
                const ix = this.selectedClasses.indexOf(cl);
    ...
    search() {
        ...
        this.searchSub = this.classService.search(this.searchForm.value).subscribe(response => {
            // console.log(response);
            this.onSearch = false;
            this.foundTrademarks = response;
        }, error => {
            if (error.status === 401) {
                console.log(error);
            }
    ...
    setAll($event) {
        const state = $event.checked ? 'selected' : 'none';
        if (!$event.checked) {
            this.selectedClasses = [];
        }
        this.classes.forEach(el => {
            el.selected = state;
            if ($event.checked) {
                this.selectedClasses.push(el.classNumber);
            }
        });
    }
    ngOnDestroy() {
...
SearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SearchComponent, selectors: [["app-search"]], decls: 36, vars: 14, consts: [[3, "ngClass", "ngClass.lt-md"], ["mat-icon-button", "", 3, "routerLink"], ["fxLayout", "column", "fxLayoutAlign", "start center", 1, "block-one"], [1, "text-main", "header", "step-long"], [1, "step-double", 2, "width", "85vw", "max-width", "830px", "padding-left", "25px", "padding-top", "25px", "padding-bottom", "25px"], ["fxLayout", "row", "fxLayout.lt-md", "column", 3, "formGroup"], ["fxFlex", "50", "fxFlex.lt-md", "100", "fxLayout", "column", "fxLayoutAlign", "space-between end", 2, "margin-right", "15px"], ["fxLayout", "column", 2, "width", "100%"], ["appearance", "outline", 2, "width", "100%"], ["matInput", "", "formControlName", "query", "type", "text"], ["fxHide", "true", "fxShow.lt-md", "true", "mat-icon-button", "", "matSuffix", "", 3, "matMenuTriggerFor"], ["matSuffix", ""], ["menu1", "matMenu"], ["fxLayout", "row wrap", "fxLayoutAlign", "center center", 1, "classes-holder"], ["class", "text-main class-element", "fxLayoutAlign", "center center", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], ["formControlName", "strong", 1, "text-main"], [1, "text-main", 3, "change"], ["fxLayout", "row", "fxLayoutAlign", "end center"], ["mat-raised-button", "", "type", "submit", 1, "button", "primary-button", 3, "disabled", "click"], ["fxFlex", "50", "fxHide.lt-md", "true", "fxLayout", "row wrap", "fxLayoutAlign", "center center", 1, "classes-holder"], ["class", "step-long", 4, "ngIf"], ["fxLayout", "column", "fxLayoutAlign", "start center", 1, "step-long", 2, "padding-bottom", "50px"], ["class", "step-regular text-main", "style", "font-size: 1.1rem", 4, "ngIf"], ["class", "step-regular", "style", "width: 85vw; max-width: 830px;", 4, "ngFor", "ngForOf"], ["fxLayoutAlign", "center center", 1, "text-main", "class-element", 3, "ngClass", "click"], [1, "step-long"], [1, "step-regular", "text-main", 2, "font-size", "1.1rem"], [1, "step-regular", 2, "width", "85vw", "max-width", "830px"], ["fxLayout", "column", "fxLayoutAlign", "start start", 2, "padding-top", "10px", "padding-bottom", "10px"], [1, "text-main", 2, "font-size", "1.2rem", "overflow-x", "fragments"], [1, "text-alternative", "step-short", 2, "font-size", "0.9rem", "font-weight", "500"], ["fxLayout", "row", "fxLayout.lt-sm", "column", "fxLayoutAlign", "start center", "fxLayoutAlign.lt-sm", "start start", 1, "step-short"], [1, "text-main"], ["ngStyle.gt-xs", "margin-left: 15px", 1, "text-main"], ["fxLayout", "column", 2, "margin-top", "0px"], [1, "text-alternative", "step-regular", 2, "font-size", "1.1rem"], [1, "text-main", 2, "font-size", ".9rem", "color", "#424242", "text-wrap", "normal"], [1, "text-alternative", "step-small", 2, "font-size", "1.1rem"], [2, "margin-top", "15px", "margin-bottom", "10px"], [1, "text-alternative", "step-short", 2, "font-size", "1.1rem"], [1, "text-main", 2, "font-size", ".9rem", "color", "#424242"]], template: function SearchComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function SearchComponent_Template_mat_checkbox_change_25_listener($event) { return ctx.setAll($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchComponent_Template_button_click_28_listener() { return ctx.search(); });
        ...
        const _r193 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](20);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SearchComponent, [{
    ...
    }], function () { return [{ type: _services_class_service__WEBPACK_IMPORTED_MODULE_2__["ClassService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
...
/* harmony import */ var _components_account_search_search_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../components/account/search/search.component */ "./src/app/components/account/search/search.component.ts");
...
const routes = [
    ...
    { path: 'search', component: _components_account_search_search_component__WEBPACK_IMPORTED_MODULE_15__["SearchComponent"] },
];
